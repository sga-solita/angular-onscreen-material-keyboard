(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('@angular/core'), require('@angular/cdk/a11y'), require('@angular/cdk/overlay'), require('@angular/cdk/portal'), require('@angular/animations'), require('@angular/material/core'), require('rxjs/operators'), require('emulate-tab'), require('@angular/forms'), require('@angular/common'), require('@angular/material/button'), require('@angular/material/icon'), require('@angular/material/input')) :
    typeof define === 'function' && define.amd ? define('angular-onscreen-material-keyboard', ['exports', 'rxjs', '@angular/core', '@angular/cdk/a11y', '@angular/cdk/overlay', '@angular/cdk/portal', '@angular/animations', '@angular/material/core', 'rxjs/operators', 'emulate-tab', '@angular/forms', '@angular/common', '@angular/material/button', '@angular/material/icon', '@angular/material/input'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['angular-onscreen-material-keyboard'] = {}, global.rxjs, global.ng.core, global.ng.cdk.a11y, global.ng.cdk.overlay, global.ng.cdk.portal, global.ng.animations, global.ng.material.core, global.rxjs.operators, global.emulateTab, global.ng.forms, global.ng.common, global.ng.material.button, global.ng.material.icon, global.ng.material.input));
}(this, (function (exports, rxjs, core$1, a11y, overlay, portal, animations, core, operators, emulateTab, forms, common, button, icon, input) { 'use strict';
    ...
    })(exports.KeyboardClassKey || (exports.KeyboardClassKey = {}));

    var _a;
    var KEYBOARD_ICONS = (_a = {},
        _a[exports.KeyboardClassKey.Bksp] = { name: 'keyboard_backspace' },
        _a[exports.KeyboardClassKey.Caps] = { name: 'keyboard_capslock' },
        _a[exports.KeyboardClassKey.Enter] = { name: 'keyboard_return' },
        _a[exports.KeyboardClassKey.Shift] = { name: 'keyboard_arrow_up' },
        _a[exports.KeyboardClassKey.Space] = { name: ' ' },
        _a[exports.KeyboardClassKey.Tab] = { name: 'keyboard_tab' },
        _a);
    ...
    })(exports.KeyboardModifier || (exports.KeyboardModifier = {}));
    ...
    ***************************************************************************** */
    ...
    })(exports.KeyboardAnimationState || (exports.KeyboardAnimationState = {}));
    ...
    })(exports.KeyboardAnimationTransition || (exports.KeyboardAnimationTransition = {}));

    // TODO: we can't use constants from animation.ts here because you can't use
    // a text interpolation in anything that is analyzed statically with ngc (for AoT compile).
    var SHOW_ANIMATION = core.AnimationDurations.ENTERING + " " + core.AnimationCurves.DECELERATION_CURVE;
    var HIDE_ANIMATION = core.AnimationDurations.EXITING + " " + core.AnimationCurves.ACCELERATION_CURVE;
    /**
    ...
    var MatKeyboardContainerComponent = /** @class */ (function (_super) {
        ...
        function MatKeyboardContainerComponent(_ngZone, _changeDetectorRef) {
            ...
            _this._animationState = exports.KeyboardAnimationState.Void;
        ...
        MatKeyboardContainerComponent.prototype.onAnimationEnd = function (event) {
            ...
            if ((toState === exports.KeyboardAnimationState.Void && fromState !== exports.KeyboardAnimationState.Void) || toState.startsWith('hidden')) {
                this._completeExit();
            }
            if (toState === exports.KeyboardAnimationState.Visible) {
        ...
        MatKeyboardContainerComponent.prototype.enter = function () {
            if (!this._destroyed) {
                this._animationState = exports.KeyboardAnimationState.Visible;
                this._changeDetectorRef.detectChanges();
            }
        };
        /** Begin animation of the snack bar exiting from view. */
        MatKeyboardContainerComponent.prototype.exit = function () {
            this._animationState = exports.KeyboardAnimationState.Hidden;
            return this.onExit;
        };
        /**
        ...
        { type: core$1.Component, args: [{
                    ...
                    animations: [
                        animations.trigger('state', [
                            animations.state("" + exports.KeyboardAnimationState.Visible, animations.style({ transform: 'translateY(0%)' })),
                            animations.transition("" + exports.KeyboardAnimationTransition.Hide, animations.animate(HIDE_ANIMATION)),
                            animations.transition("" + exports.KeyboardAnimationTransition.Show, animations.animate(SHOW_ANIMATION))
                        ])
                    ],
    ...
    MatKeyboardContainerComponent.propDecorators = {
        ...
        _animationState: [{ type: core$1.HostBinding, args: ['@state',] }],
        attrRole: [{ type: core$1.HostBinding, args: ['attr.role',] }],
        onMousedown: [{ type: core$1.HostListener, args: ['mousedown', ['$event'],] }],
        onAnimationEnd: [{ type: core$1.HostListener, args: ['@state.done', ['$event'],] }]
    };
     ...
     *
     */
    var MAT_KEYBOARD_LAYOUTS = new core$1.InjectionToken('keyboard-layouts.config');
    var keyboardLayouts = {
        '\u0627\u0644\u0639\u0631\u0628\u064a\u0629': {
            'name': 'Arabic',
            'keys': [
                [
                    ...
                    ['-', '_', '\u00a5'],
                    ['=', '+', '\u00d7', '\u00f7'],
                    [exports.KeyboardClassKey.Bksp, exports.KeyboardClassKey.Bksp, exports.KeyboardClassKey.Bksp, exports.KeyboardClassKey.Bksp]
                ],
                [
                    [exports.KeyboardClassKey.Tab, exports.KeyboardClassKey.Tab, exports.KeyboardClassKey.Tab, exports.KeyboardClassKey.Tab],
                    ['\u0636', '\u064e'],
                    ['\u0635', '\u064b'],
                    ['\u062b', '\u064f'],
                    ['\u0642', '\u064c'],
                ...
                [
                    [exports.KeyboardClassKey.Caps, exports.KeyboardClassKey.Caps, exports.KeyboardClassKey.Caps, exports.KeyboardClassKey.Caps],
                    ['\u0634', '\u0650'],
                    ['\u0633', '\u064d'],
                    ['\u064a', ']'],
                    ['\u0628', '['],
                ...
                [
                    ...
                    [exports.KeyboardClassKey.Alt, exports.KeyboardClassKey.Alt, exports.KeyboardClassKey.Alt, exports.KeyboardClassKey.Alt]
                ]
            ],
            'lang': ['ar']
        },
        ...
        'Dingbats': {
            ...
            'keys': [
                ...
                [
                    [exports.KeyboardClassKey.AltLk, exports.KeyboardClassKey.AltLk, exports.KeyboardClassKey.AltLk, exports.KeyboardClassKey.AltLk],
                    [exports.KeyboardClassKey.Space, exports.KeyboardClassKey.Space, exports.KeyboardClassKey.Space, exports.KeyboardClassKey.Space],
                    [exports.KeyboardClassKey.AltGr, exports.KeyboardClassKey.AltGr, exports.KeyboardClassKey.AltGr, exports.KeyboardClassKey.AltGr]
                ]
            ]
        ...
        '\ud55c\uad6d\uc5b4': {
            ...
            'keys': [
                ...
                [
                    [exports.KeyboardClassKey.Space, exports.KeyboardClassKey.Space, exports.KeyboardClassKey.Space, exports.KeyboardClassKey.Space],
                    ['Kor', exports.KeyboardClassKey.Alt]
                ]
            ],
            'lang': ['ko']
        },
        ...
        '\u067e\u069a\u062a\u0648': {
            ...
            'keys': [
                ...
                [
                    ...
                    ['\u0696', '.', '\u06c7'],
                    ['/', '\u061f', '\u06c9'],
                    [exports.KeyboardClassKey.Shift, exports.KeyboardClassKey.Shift, '\u064d']
                ],
                [
                    [exports.KeyboardClassKey.Space, exports.KeyboardClassKey.Space, exports.KeyboardClassKey.Space, exports.KeyboardClassKey.Space],
                    [exports.KeyboardClassKey.Alt, exports.KeyboardClassKey.Alt, exports.KeyboardClassKey.Alt, exports.KeyboardClassKey.Alt]
    ...
    MatKeyboardService.ctorParameters = function () { return [
        ...
        { type: undefined, decorators: [{ type: core$1.Inject, args: [MAT_KEYBOARD_LAYOUTS,] }] },
        { type: MatKeyboardService, decorators: [{ type: core$1.Optional }, { type: core$1.SkipSelf }] }
    ]; };

    // - Lay out each dead key set as an object of property/value
    var MAT_KEYBOARD_DEADKEYS = new core$1.InjectionToken('keyboard-deadkey.config');
    ...
    var MatKeyboardKeyComponent = /** @class */ (function () {
        ...
        function MatKeyboardKeyComponent(_deadkeys) {
            ...
            this.genericClick = new core$1.EventEmitter();
            this.enterClick = new core$1.EventEmitter();
            this.bkspClick = new core$1.EventEmitter();
            this.capsClick = new core$1.EventEmitter();
            this.altClick = new core$1.EventEmitter();
            this.shiftClick = new core$1.EventEmitter();
            this.spaceClick = new core$1.EventEmitter();
            this.tabClick = new core$1.EventEmitter();
            this.keyClick = new core$1.EventEmitter();
        }
        ...
        Object.defineProperty(MatKeyboardKeyComponent.prototype, "isClassKey", {
            get: function () {
                return this.key in exports.KeyboardClassKey;
            },
            enumerable: false,
            configurable: true
        });
        ...
        MatKeyboardKeyComponent.prototype.onClick = function (event) {
            ...
            switch (this.key) {
                ...
                case exports.KeyboardClassKey.Alt:
                case exports.KeyboardClassKey.AltGr:
                case exports.KeyboardClassKey.AltLk:
                    this.altClick.emit(event);
                    break;
                case exports.KeyboardClassKey.Bksp:
                    this.deleteSelectedText();
                    this.bkspClick.emit(event);
                    break;
                case exports.KeyboardClassKey.Caps:
                    this.capsClick.emit(event);
                    break;
                case exports.KeyboardClassKey.Enter:
                    if (this._isTextarea()) {
                        char = VALUE_NEWLINE;
                    }
                    else {
                    ...
                    break;
                case exports.KeyboardClassKey.Shift:
                    this.shiftClick.emit(event);
                    break;
                case exports.KeyboardClassKey.Space:
                    char = VALUE_SPACE;
                    this.spaceClick.emit(event);
                    break;
                case exports.KeyboardClassKey.Tab:
                    var switchedInput = emulateTab.emulateTab(); // Attempt to go to the next input
                    if (!switchedInput) {
    ...
    MatKeyboardKeyComponent.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: core$1.Inject, args: [MAT_KEYBOARD_DEADKEYS,] }] }
    ]; };
    MatKeyboardKeyComponent.propDecorators = {
        key: [{ type: core$1.Input }],
        icon: [{ type: core$1.Input }],
        active: [{ type: core$1.Input }],
        pressed: [{ type: core$1.Input }],
        input: [{ type: core$1.Input }],
        control: [{ type: core$1.Input }],
        genericClick: [{ type: core$1.Output }],
        enterClick: [{ type: core$1.Output }],
        bkspClick: [{ type: core$1.Output }],
        capsClick: [{ type: core$1.Output }],
        altClick: [{ type: core$1.Output }],
        shiftClick: [{ type: core$1.Output }],
        spaceClick: [{ type: core$1.Output }],
        tabClick: [{ type: core$1.Output }],
        keyClick: [{ type: core$1.Output }]
    };
    ...
    var MatKeyboardComponent = /** @class */ (function () {
        ...
        function MatKeyboardComponent(_locale, _keyboardService) {
            ...
            this._modifier = exports.KeyboardModifier.None;
        ...
        MatKeyboardComponent.prototype.isActive = function (key) {
            ...
            var isActiveCapsLock = modifiedKey === exports.KeyboardClassKey.Caps && this._capsLocked;
            var isActiveModifier = modifiedKey === exports.KeyboardModifier[this._modifier];
        ...
        MatKeyboardComponent.prototype.getKeyIcon = function (key) {
            return this._icons[key[exports.KeyboardModifier.None]];
        };
        /**
        ...
        MatKeyboardComponent.prototype.onKeyDown = function (event) {
            ...
            if (event.key === exports.KeyboardClassKey.Caps) {
                this.onCapsClick(event.getModifierState(exports.KeyboardClassKey.Caps));
            }
            if (event.key === exports.KeyboardClassKey.Alt && this._modifier !== exports.KeyboardModifier.Alt && this._modifier !== exports.KeyboardModifier.ShiftAlt) {
                this.onAltClick();
            }
            if (event.key === exports.KeyboardClassKey.Shift && this._modifier !== exports.KeyboardModifier.Shift && this._modifier !== exports.KeyboardModifier.ShiftAlt) {
                this.onShiftClick();
            }
        };
        /**
        ...
        MatKeyboardComponent.prototype.onKeyClick = function () {
            if (this._modifier === exports.KeyboardModifier.Shift || this._modifier === exports.KeyboardModifier.ShiftAlt) {
                this._modifier = this._invertShiftModifier(this._modifier);
            }
            if (this._modifier === exports.KeyboardModifier.Alt || this._modifier === exports.KeyboardModifier.ShiftAlt) {
        ...
        MatKeyboardComponent.prototype._invertAltModifier = function (modifier) {
            switch (modifier) {
                case exports.KeyboardModifier.None:
                    return exports.KeyboardModifier.Alt;
                case exports.KeyboardModifier.Shift:
                    return exports.KeyboardModifier.ShiftAlt;
                case exports.KeyboardModifier.ShiftAlt:
                    return exports.KeyboardModifier.Shift;
                case exports.KeyboardModifier.Alt:
                    return exports.KeyboardModifier.None;
            }
        };
    ...
    MatKeyboardComponent.propDecorators = {
        _keys: [{ type: core$1.ViewChildren, args: [MatKeyboardKeyComponent,] }],
        cssClass: [{ type: core$1.HostBinding, args: ['class.mat-keyboard',] }],
        onKeyDown: [{ type: core$1.HostListener, args: ['document:keydown', ['$event'],] }],
        onKeyUp: [{ type: core$1.HostListener, args: ['document:keyup', ['$event'],] }]
    };
    ...
    MatKeyboardDirective.propDecorators = {
        matKeyboard: [{ type: core$1.Input }],
        darkTheme: [{ type: core$1.Input }],
        duration: [{ type: core$1.Input }],
        isDebug: [{ type: core$1.Input }],
        enterClick: [{ type: core$1.Output }],
        capsClick: [{ type: core$1.Output }],
        altClick: [{ type: core$1.Output }],
        shiftClick: [{ type: core$1.Output }],
        showKeyboard: [{ type: core$1.HostListener, args: ['focus', ['$event'],] }],
        hideKeyboard: [{ type: core$1.HostListener, args: ['blur', ['$event'],] }]
    };
    ...
    exports.KEYBOARD_ICONS = KEYBOARD_ICONS;
...
//# sourceMappingURL=angular-onscreen-material-keyboard.umd.js.map
